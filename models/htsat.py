...
class HTSAT_Swin_Transformer(nn.Module):
    ...
    def __init__(self, spec_size=256, patch_size=4, patch_stride=(4, 4),
        ...
        self.audio_feats_extractor = AudioFeature(config.to_dict())
    ...
    def reshape_wav2img(self, x):
        ...
        assert T <= target_T and F <= target_F, f"the wav size should less than or equal to the swin input size, {T}, {target_T}"
...
if __name__ == '__main__':
    ...
    print(output_dict)
    print(output_dict["fine_grained_embedding"].shape)
