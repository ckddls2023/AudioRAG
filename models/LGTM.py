...
class LGTM(nn.Module):
    def __init__(self,
        ...
        self.ln_audio = nn.LayerNorm(self.hidden_size, eps=1e-12)
        self.ln_text = nn.LayerNorm(self.hidden_size, eps=1e-12)
    ...
    def forward(self, audio_embeds, caption):
        ...
        text_embeds = self.ln_text(text_embeds) # LayerNorm
